...
%     fprintf(S_Hokuyo,'GD0044072500');           % request a new Lidar scan
    ...
    if i == 1
        ...
        total_err(i)=0;
        omega = 0;
        SetDriveWheelsSMART(S_Create, Create_Full_Speed*.3, Create_Full_Speed*.3, CliffLeft,CliffRight,CliffFrontLeft,CliffFrontRight,BumpRight,BumpLeft,BumpFront);
    end
    ...
    SetDriveWheelsSMART(S_Create, Create_Full_Speed*.3-(omega/2), Create_Full_Speed*.3+(omega/2), CliffLeft,CliffRight,CliffFrontLeft,CliffFrontRight,BumpRight,BumpLeft,BumpFront);
